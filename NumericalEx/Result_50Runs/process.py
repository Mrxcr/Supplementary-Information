...
fig.show()
print(r"Save Figure 2 at SuppMaterial\NumericalEx\Result_50Runs\Figures\Figure 2.png.")
...
fig.update_yaxes(showline=True, linewidth=2, linecolor='black', gridcolor='black', mirror=True, ticks='outside')
fig.show()
print(r"Save Figure 6 at SuppMaterial\NumericalEx\Result_50Runs\Figures\Figure 6.png.")
...
fig.update_yaxes(showline=True, linewidth=2, linecolor='black', gridcolor='black', mirror=True, ticks='outside')
fig.show()
print(r"Save Figure 5 at SuppMaterial\NumericalEx\Result_50Runs\Figures\Figure 5.png.")
